        ...
        <ul class="nav" id="menuItems">
            ...
            <li class="nav-item menu-items">
                ...
                <div class="collapse" id="home-slider">
                    <ul class="nav flex-column sub-menu">
                        <li class="nav-item"> <a class="nav-link" href="">Hero Area</a></li>
            ...
            <li class="nav-item menu-items">
                ...
                <div class="collapse" id="products">
                    <ul class="nav flex-column sub-menu">
                        ...
                        <li class="nav-item"> <a class="nav-link" href="">Manage Items</a>
                        </li>
            ...
            <li class="nav-item menu-items">
                ...
                <div class="collapse" id="chefs">
                    <ul class="nav flex-column sub-menu">
                        <li class="nav-item"> <a class="nav-link" href="">Add Chefs</a></li>
